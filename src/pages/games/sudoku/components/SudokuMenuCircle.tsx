...
import { SUDOKU_NUMBERS } from "@/src/lib/sudoku/engine/utility";
import { Cell } from "@/src/lib/sudoku/engine/types";
  ...
  return (
    ...
    >
      <circle
        ...
        fill="none"
        className={notesMode ? "stroke-sky-300 dark:stroke-sky-700" : "stroke-teal-300 dark:stroke-teal-700"}
      />
      {SUDOKU_NUMBERS.map((number, i) => {
        ...
        const stroke = menuColorSet[i % menuColorSet.length];
