...
import { CellCoordinates, Cell } from "@/src/lib/sudoku/engine/types";
      ...
      {SUDOKU_NUMBERS.map((n) => {
        ...
        return (
          ...
          >
            {showOccurrences && (
              <div
                className="absolute right-0 bottom-0 h-3 w-3 rounded-xl bg-teal-700 text-[10px] text-white opacity-70 sm:right-1 sm:bottom-1 sm:h-4 sm:w-4 sm:text-xs "
