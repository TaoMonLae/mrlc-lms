      ...
      .then((data) => {
        if (data) {
          setFormData({
            ...
            taxId: data.taxId || '',
            receiptPreference: data.receiptPreference || 'EMAIL',
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" render={<Link to={`/donors/${id}`} />} nativeButton={false}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setFormData({ ...formData, doNotContact: checked })}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" render={<Link to={`/donors/${id}`} />} nativeButton={false}>
            Cancel
          </Button>
