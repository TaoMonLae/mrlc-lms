...
import { Building2, Palette, Settings as SettingsIcon, Shield, ChevronRight, DatabaseBackup, Rss, Trash2 } from 'lucide-react';
...
export default function SettingsLayout() {
  ...
  const navItems = [
    ...
    { name: 'Delete Exam Records', path: '/settings/exam-records', icon: Trash2 },
  ];
