...
const copy = {
  en: {
    ...
    lessonGuideBody: 'Take your time. The same five-step routine helps you understand, recognize, spell, build, and recall useful language.',
    learnTitle: '1. Learn',
  ...
  my: {
    ...
    lessonGuideBody: 'အလျင်မလိုပါ။ နားလည်ခြင်း၊ ရွေးချယ်မှတ်သားခြင်း၊ စာလုံးပေါင်းခြင်း၊ ဝါကျတည်ဆောက်ခြင်းနှင့် ပြန်လည်မှတ်မိခြင်းတို့ကို အဆင့်ငါးဆင့်ဖြင့် လေ့ကျင့်ပေးမည်။',
