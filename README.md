...
- Certificates now require a monitored final exam after every scored course practice is complete. Exams use randomized server-graded questions, require 80% to pass, enforce a 30-minute limit, terminate when the learner leaves the protected screen, and apply a 15-minute review break after failed or terminated attempts. Dictation-enabled language courses include typed spelling questions; Mathematics and GED exams use subject-appropriate scored questions.
...
- The public catalog and signed-in learner dashboard organize current published content into collapsible **Chinese Courses**, **English Courses**, **Malay Courses**, **Mathematics Courses**, and **GED Preparation** folders, with additional categories appearing when they contain published courses.
