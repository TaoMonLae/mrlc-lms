...
TRANSLATIONS = {
    "my": {
        ...
        "Preview of your print-ready Language Quest certificate.": "ပုံနှိပ်ရန် အဆင်သင့်ဖြစ်သော သင်၏ Language Quest လက်မှတ်၏ အစမ်းကြည့်ရှုမှု။",
        ...
        "Language Quest progress keepsake": "Language Quest တိုးတက်မှု အမှတ်တရ",
        ...
        "A teacher can share an eight-character code. Joining lets that teacher see your Language Quest points, streak, activity date, progress, and learned words in the class focus course. Learning from other courses stays private.": "ဆရာက ၈ လုံးပါသော ကုဒ်ကို မျှဝေနိုင်သည်။ ပူးပေါင်းခြင်းဖြင့် ထိုဆရာသည် သင်၏ Language Quest ရမှတ်များ၊ နေ့စဉ်ဆက်တိုက်မှတ်တမ်း၊ လှုပ်ရှားမှုရက်စွဲ၊ တိုးတက်မှုနှင့် အတန်း၏အဓိကသင်တန်းတွင် လေ့လာခဲ့သောစကားလုံးများကို မြင်နိုင်မည်ဖြစ်သည်။ အခြားသင်တန်းများမှ လေ့လာမှုများသည် လျှို့ဝှက်အဖြစ် ဆက်လက်ရှိနေမည်ဖြစ်သည်။",
    ...
    "mnw": {
        ...
        "Preview of your print-ready Language Quest certificate.": "ဗဵုစမ်ၜတ်လိက်သက်သဳ Language Quest မဆိုက်ပ္တိတ်။",
        ...
        "Language Quest progress keepsake": "တၚ်စမ္တီပရေၚ်ဇၞော်မောဝ် Language Quest",
