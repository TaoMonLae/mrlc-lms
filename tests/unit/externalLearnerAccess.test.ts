...
test("external learners stay within the Language Quest browser routes", () => {
  const allowed = [
    ...
    "/games/language-quest/words",
    "/games/language-quest/courses/course-1",
    "/games/language-quest/courses/course-1/boss-battle",
    "/games/language-quest/courses/course-1/final-exam",
    "/games/language-quest/courses/course-1/culture",
    "/games/language-quest/courses/course-1/story/market-day",
...
test("external learner API access uses an explicit method and route allowlist", () => {
  const allowed: Array<[string, string]> = [
    ...
    ["GET", "/api/language-quest/voice"],
    ["GET", "/api/language-quest/learned-words?courseId=course-1"],
    ["GET", "/api/language-quest/courses/course-1"],
    ["GET", "/api/language-quest/courses/course-1/boss-battle"],
    ...
    ["POST", "/api/language-quest/courses/course-1/boss-battle/finish"],
    ["POST", "/api/language-quest/courses/course-1/final-exam/start"],
    ["POST", "/api/language-quest/courses/course-1/final-exam/audio"],
    ["POST", "/api/language-quest/courses/course-1/final-exam/finish"],
    ["POST", "/api/language-quest/courses/course-1/final-exam/violation"],
